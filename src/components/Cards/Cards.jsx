...
function Cards(props) {
  ...
  const handleSaveClick = () => {
    if (cookies.get("loggedIn") == false || cookies.get("loggedIn") == null) {
    ...
    <div className={styles.card}>
      ...
      <div className={styles.cardHeader}>
        ...
        <div className={styles.cardProperties}>
          <h2 className={styles.cardTitle} onClick={(e) => handlePage(e)}>
            {props.title}
          </h2>
        ...
        {/* save button */}
        <button
          className={`${styles.cardSavedButton} ${isSaved ? styles.saved : ""}`}
