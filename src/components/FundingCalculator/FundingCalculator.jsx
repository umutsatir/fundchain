  ...
  return (
    <div className={styles.modalOverlay}>
      <div className={styles.modalContent}>
        ...
        <p>
          Enter the estimated amount you think you will need to make this project. Do not forget that building out a budget that includes shipping, materials, research, vendors, and labor costs.
        </p>
        ...
        <div className={styles.taxRateContainer}>
          ...
          <p className={styles.taxAmount} style={{ color: isActive ? 'black' : 'gray' }}>
            {currency} {taxAmount.toFixed(2)}
          </p>
        </div>

        <div className={styles.feesContainer}>
          <div className={styles.feeTitle} style={{ color: isActive ? 'black' : 'gray' }}>
            <p>Fundchain Fee (5%):</p>
            <p>Processing Fee (5%):</p>
            <p>Suggested Goal:</p>
          </div>
          <div className={styles.feeAmount} style={{ color: isActive ? 'black' : 'gray' }}>
            <p>{currency} {fundchainFee.toFixed(2)}</p>
            <p>{currency} {processingFee.toFixed(2)}</p>
            <p>{currency} {suggestedGoal.toFixed(2)}</p>
          </div>
        </div>

        <button
          className={styles.button}
          onClick={() => { handleSelect(); onClose(); }}
          disabled={!isActive}
        >
          Use Suggested Goal
        </button>
